"""Refactored Spot Trades Download using BaseDownload with improvements."""
import sys
...
class SpotTradesDownload(Download):
    """Spot Trades Download - Refactored version with improvements."""
...
if __name__ == "__main__":
    downloader = SpotTradesDownload(base_start_date="2025-01-01")
    downloader.run()
